...
class CarDetector(PytorchAbstractClassifierUDF):
    """
    Arguments:
    ...
    def forward(self, frames: Tensor) -> pd.DataFrame:
        ...
        for prediction in predictions:
            ...
            # filter only cars
            car_indices = np.where(pred_class == "car")
            pred_boxes = pred_boxes[car_indices]
            pred_class = pred_class[car_indices]
            pred_score = pred_score[car_indices]
